function PropertyViewGuest() {
    return (
        <div>

            <div class="container d-flex justify-content-start pt-3">
                <a class="btn button-darken" style={{ background: '#85bded' }} href="hostproperties" role="button">❮ Go back to home page</a>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8 col-xxl-8 ">
                    <div class="pad-move">
                        <h5 class="d-flex justify-content-start pt-3">Reserve</h5>
...
export default PropertyViewGuest;
