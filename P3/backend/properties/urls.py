...
urlpatterns = [ 
    ...
    path('property-image-create/<int:pk>/', views.CreatePropertyImage.as_view(), name='property-image-create'),
    path('property-image-list/<int:pk>/', views.PropertyImageList.as_view(), name='property-image-list'),
    path('property-image-delete/<int:pk>/', views.PropertyImageDelete.as_view(), name='property-image-delete'),
